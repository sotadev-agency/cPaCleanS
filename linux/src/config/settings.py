"""Configuracion global de cPacleanS (build Linux)."""
import os
import json
...
# Linux: respeta XDG Base Directory (~/.config/cPacleanS); APPDATA no existe en
# este SO. Mantiene APPDATA como fallback por si el modulo se ejecuta bajo Wine.
CONFIG_DIR = Path(os.environ.get("APPDATA") or os.environ.get("XDG_CONFIG_HOME")
